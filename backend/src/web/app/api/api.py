...
from .endpoints import users, auth, roles, files, events, competitions, age_groups
...
api.include_router(events.crud_event_types, prefix='/event_types', tags=['event_types'])
